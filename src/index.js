...
var app = (function() {
    ...
    let requestData = function(){
        ...
        xhttp.open("GET", "ttps://date.nager.at/api/v3/NextPublicHolidaysWorldwide", true);
        xhttp.send();
    }
    ...
    let _createListItem = function(itemText, btnText){
        ...
        btn.addEventListener("click", function(){ app.addItemToRemlist(this); });  // adds an eventlistener to the button with a public function from app
    ...
    return {
        ...
        addItemToRemlist: addItemToRemlist
    }
}());